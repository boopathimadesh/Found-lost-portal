...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (addItem($_SESSION['user']['id'], $title, $description, $category, $location, $date, 'found', $imagePath, $videoPath, $collectionLocation)) {
...
<div class="form-container">
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" placeholder="Describe the item in detail (color, size, brand, condition)" required></textarea>
        </div>
        ...
        <div class="form-group">
            <label for="location" class="required">Where did you find it?</label>
            <input type="text" id="location" name="location" placeholder="e.g., Library, Cafeteria, Block A" required>
        </div>
        
        <div class="form-group">
            <label for="date" class="required">When did you find it?</label>
            <input type="date" id="date" name="date" required>
        </div>
        
        <div class="form-group">
            <label for="collection_location">Where can the owner collect it?</label>
            <input type="text" id="collection_location" name="collection_location" placeholder="e.g., Admin Office, Security Desk">
        </div>
        
        <div class="form-group">
            <label for="image">Upload Image (Optional but highly recommended)</label>
            <input type="file" id="image" name="image" accept="image/*">
            <p class="file-note">Adding a photo helps owners identify their items more easily</p>
        </div>
